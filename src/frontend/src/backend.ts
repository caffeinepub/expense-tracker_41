...
export class Backend implements backendInterface {
    ...
    async getCategoryStats(): Promise<Array<CategoryStat>> {
        if (this.processError) {
            try {
    ...
    async getMonthlyBudget(): Promise<number | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getMonthlyBudget();
    ...
    async getMonthlyStats(): Promise<{
        ...
        if (this.processError) {
            try {
                const result = await this.actor.getMonthlyStats();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateTransaction(arg0: bigint, arg1: string, arg2: number, arg3: string, arg4: string, arg5: string): Promise<void> {
        if (this.processError) {
            try {
